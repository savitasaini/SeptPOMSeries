...
public class BasePage {
	...
	/**
	 * this method is usded to read the properties from config.properties file
	 * @return prop
	 */
	public Properties init_properties(){
		 ...
		 prop= new Properties();
		try {
			FileInputStream ip = new FileInputStream("/Users/savita/workspace/SeptBatchPOMSerie/src/main/config.properties");
			prop.load(ip);
